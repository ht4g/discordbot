...
if (process.argv.length <= 2) {
    console.log("\x1b[36m USAGE\x1b[37m: node HTTP-KILLER.js <target> <time> <thread>");
    console.log("\x1b[32m EXAMPLE\x1b[37m: node HTTP-KILLER.js https://example.com 60 100");
